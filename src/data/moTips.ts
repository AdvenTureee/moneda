...
export const MO_TIPS: MoTip[] = [
  ...
  { id: 'fin-orcamento', kind: 'finance', text: 'Orçamento não é restrição; é dar permissão consciente para cada gasto.' },
  ...
  { id: 'app-insights', kind: 'app', text: 'Toque em Insights para eu analisar seus gastos do mês e mostrar padrões.' },
  { id: 'app-feed', kind: 'app', text: 'No Feed, dá para filtrar gastos por categoria, busca e período. Útil para achar aquela compra antiga.' },
  ...
  { id: 'app-categorias', kind: 'app', text: 'Crie categorias personalizadas em Perfil → Categorias para refletir como você organiza sua vida.' },
  { id: 'app-receitas', kind: 'app', text: 'Cadastre ganhos em Perfil → Ganhos para abater estouros no mês em que eles forem recebidos.' },
  { id: 'app-toque', kind: 'app', text: 'Toque em mim para eu te dar a próxima dica. 🙂' },
];
