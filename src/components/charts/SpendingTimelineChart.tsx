          ...
          {mode === 'day' && (
            <div className="flex w-full justify-start sm:w-auto sm:justify-end">
              <DatePicker
                ...
                className="themed-field inline-flex h-9 w-auto min-w-[136px] items-center gap-2 rounded-[10px] border border-[#E5E7EB] bg-white px-2.5 text-left text-sm font-semibold outline-none transition-colors hover:border-[#A8C5E0] focus:border-[#A8C5E0] disabled:cursor-not-allowed disabled:opacity-50"
              />
            </div>
          )}
        </div>
